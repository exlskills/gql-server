...
export const resolveGetCardByQuestion = async (obj, args, viewer, info) => {
  logger.debug(`in resolveGetCardByQuestion`);
...
export const resolveGetCard = async (obj, args, viewer, info) => {
  logger.debug(`in resolveGetCard`);
  let fetchParameters = {};
  if (obj) {
